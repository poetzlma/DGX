...
>
> **The resident is bandwidth-capped, not single-stream.** `qwen3.8-27b` accepts `max-num-seqs=4`, but aggregate decode is **flat past c=2** (~14 t/s @120 k either way) — wide fan-out adds latency to every in-flight request without finishing more work. Shape clients for 1–2 concurrent ([decision §42](decisions.md#42-qwen38-27b-nvfp4-is-the-coding-default-ds4-dormant-2026-08-16)).
>
